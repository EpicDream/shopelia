  ...
  class WebgainsFiler < Filer
    ...
    def initialize(params={})
      ...
      self.urls = params[:urls] || [
        'http://content.webgains.com/affiliates/datafeed.html?action=download&campaign=145659&username=shopelia&password=pichon69&format=xml&zipformat=gzip_notar&fields=extended&feeds=all&allowedtags=all&categories=all'
      ]
