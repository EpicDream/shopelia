...
var Uri = (function () {
  ...
  */
  ...
  Uri.prototype.href = function (val) {
    if (typeof val !== 'undefined') {
      var uri = Uri(val);
      this.uriParts = uri.uriParts;
      this.queryObj = uri.queryObj;
      this.hasAuthorityPrefixUserPref = uri.hasAuthorityPrefixUserPref;
    }
    return this.uriParts.source;
  };
