 ...
 */
define(["./chrome/compat", "./filterNotifier", "./filterClasses"], function(Compat, FilterNotifier, FilterClasses) {
...
SpecialSubscription.prototype =
{
  ...
  isDefaultFor: function(filter)
  {
    ...
    {
      for each (var type in this.defaults)
      {
