...
define(["../filterNotifier"], function(FilterNotifier) {
  ...
  Compat.Cc = Compat.Components.classes;
  Compat.Ci = Compat.Components.interfaces;
  ...
  Compat.FakeFile.prototype = {
    ...
    clone: function() {
      return new FakeFile(this.leafName);
    },
    get parent() {
  ...
  Compat.FakeTimer = function () {};
  Compat.FakeTimer.prototype = {
    delay: 0,
    callback: null,
