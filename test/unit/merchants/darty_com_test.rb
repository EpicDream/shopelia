...
class DartyComTest < ActiveSupport::TestCase
  ...
  setup do
    @helper = DartyCom.new("http://www.darty.com/nav/achat/gros_electromenager/refrigerateur_congelateur-refrigerateur-cong/refrigerateur_congelateur_bas/samsung_rl56gsbsw.html")
  end
