class OrdersDatatable
  ...
  def data
    orders.map do |order|
      ...
      [
        link_to(image_tag(product ? product.image_url.blank? ? "empty.png" : product.image_url : "empty.png", style:"max-width:100px;max-height:40px"), "https://vulcain.shopelia.fr:444/admin/logs/#{order.uuid}"),
