class Api::V1::AddressesController < Api::V1::BaseController
  ...
  def_param_group :address do
    param :address, Hash, :required => true, :action_aware => true do
      ...
      param :phone, String, "Phone number associated to address", :required => true
      param :reference, String, "Reference token to a Google Place object. Address will be created from this object, and overrides all other data", :required => false
